...
struct CustomControllerAPI {
    ...
    virtual coro::Promise<bool> connect() {
        co_return false;
    }

    virtual coro::Promise<std::optional<std::string>> request_uuid() {
    ...
    virtual coro::Promise<bool> start_app([[maybe_unused]] std::string intent) {
        co_return false;
    }

    virtual coro::Promise<bool> stop_app([[maybe_unused]] std::string intent) {
        co_return false;
    }
    ...
    virtual coro::Promise<bool> touch_up([[maybe_unused]] int32_t contact) {
        co_return false;
    }

    virtual coro::Promise<bool> press_key([[maybe_unused]] int32_t keycode) {
        co_return false;
    }

    virtual coro::Promise<bool> input_text([[maybe_unused]] std::string text) {
        co_return false;
    }
};
