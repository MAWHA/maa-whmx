...
template <typename Type, uint32_t TouchMask, uint32_t KeyMask, uint32_t ScreencapMask, typename IType>
struct ControllerType {
    ...
    uint32_t screencap() const {
        return type_ & ScreencapMask;
    }
